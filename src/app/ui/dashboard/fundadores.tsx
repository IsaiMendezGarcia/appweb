...
export default function Fundadores() {
    ...
    // Estados y datos para el equipo
    const team = [ 
        {
            id: 1,
    ...
    const duplicatedTeam = [...team, ...team]; // Para efecto infinito
                            ...
                            <div className="w-full max-w-6xl relative">
                                <div className="relative overflow-hidden">
                                    <div 
                                        ...
                                        style={{
                                            transform: `translateX(-${currentTeam * (100 / (window.innerWidth < 768 ? 1 : 3))}%)`,
                                            width: `${duplicatedTeam.length * (100 / (window.innerWidth < 768 ? 8 : 8))}%`
                                        }}
                                    >
